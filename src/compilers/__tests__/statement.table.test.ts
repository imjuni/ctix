...
describe('StatementTable', () => {
  ...
  it('get key', () => {
    ...
    const r01 = StatementTable.key('ironman');
    const r02 = StatementTable.key(context[0].statement);
    const r03 = StatementTable.key(statement);
  ...
  it('insert and select', () => {
    ...
    const r02 = st.select(StatementTable.key(context[0].statement));
